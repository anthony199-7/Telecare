...
const userSchema = new mongoose.Schema(
  {
    ...
    password: {
      type: String,
      required: true,
      select: false, // Recommended: Prevents password hash from being retrieved in queries by default
    },
    image: {
      type: String,
      default:
    ...
    address: {
      type: Object, // Stores structured address data
      default: { line1: "", line2: "" },
    },
    gender: {
      type: String,
    ...
    dob: {
      // Date of Birth
      type: Date, // Changed to Date type for proper storage/querying
      default: null, // Better to use null or leave empty than a string
    },
    phone: {
      type: String,
      default: "0000000000",
...
// Create the Model
// This checks if the model already exists before creating it (useful in hot-reloading environments)
const UserModel = mongoose.models.user || mongoose.model("user", userSchema);

// Use this line if you fix the module error and use 'import mongoose from "mongoose";'
