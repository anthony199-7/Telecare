  ...
  return (
    <div className="flex items-center justify-between lg:text-4xl text-blue py-1 mb-5 border-b border-b-white-400 bg-white-800 md:text-2xl ">
      <img
        ...
        alt=""
        className="w-50 h- cursor-pointer"
      />
      <div className="  text-5xl absolute m-35 ">
        <h1 className="">Telecare</h1>
      </div>
      ...
      <div className="flex items-center gap-4">
        ...
        <div
          ...
          <div className="flex items-center justify-between px-5 py-6">
            <img className="w-36" src={assets.telecare_login} alt="" />
            <img
              className="w-7"
          ...
          <ul className="flex items-center gap-2 mt-5 px-5 text-lg font-medium">
